...
class ProgressRedeemAssertion {
   ...
   * @param {string} redeemInitiator Address which makes redeem transaction.
   */
  async verify(event, redeemRequest, transactionFees, initialBalances, proofProgress, redeemInitiator) {
   ...
   * @private
   */
  async _assertBalancesForRedeem(redeemRequest, initialBalances, transactionFees, redeemInitiator) {
    const finalBalances = await this.captureBalances(redeemInitiator || redeemRequest.redeemer);
