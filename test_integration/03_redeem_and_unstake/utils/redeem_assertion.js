...
class RedeemAssertion {
     ...
     * @param {Object} event Event object after decoding.
     * @param {number}gasConsumption Gas consumption in redeem request.
     * @param {Balances} initialBalances Initial baseToken and token balances.
     */
    async verify(event, redeemRequest, gasConsumption, initialBalances) {
     ...
     * @param {string} redeemer Redeemr address.
     ...
     * @private
     */
    async _assertBalancesForRedeem(redeemRequest, initialBalances, gasConsumption) {
        ...
        const expectedRedeemerBaseTokenBalance = initialBalances.baseToken.redeemer
            .sub(redeemRequest.bounty).sub(gasConsumption);
