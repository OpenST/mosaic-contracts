...
contract('RedeemPool.rejectRedeemRequest() ', (accounts) => {
  ...
  it('should be able to reject redeem request', async () => {
    ...
    await redeemPool.rejectRedeemRequest(
      redeemRequest.amount,
      redeemRequest.beneficiary,
      redeemRequest.gasPrice,
      redeemRequest.gasLimit,
  ...
  it('should emit event', async () => {
    ...
    const result = await redeemPool.rejectRedeemRequest(
      redeemRequest.amount,
      redeemRequest.beneficiary,
      redeemRequest.gasPrice,
      redeemRequest.gasLimit,
    ...
    const eventData = events.RedeemRejected;
  ...
  it('should allow new redeem request after reject redeem request', async () => {
    await redeemPool.requestRedeem(
      redeemRequest.amount,
      redeemRequest.beneficiary,
      redeemRequest.gasPrice,
  ...
  it('should fail reject redeem request if no open redeem request', async () => {
    await Utils.expectRevert(redeemPool.rejectRedeemRequest(
      redeemRequest.amount,
      redeemRequest.beneficiary,
      redeemRequest.gasPrice,
      redeemRequest.gasLimit,
