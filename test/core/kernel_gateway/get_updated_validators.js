...
contract('KernelGateway.getUpdatedValidators()', async (accounts) => {
  ...
  it('should return blank array of validator addresses and weights when ' +
    'kernel hash is not open kernel hash', async () => {

    let result = await kernelGateway.getUpdatedValidators.call(randomHash);
  ...
  it('should return blank array for validator addresses and weights for the ' +
