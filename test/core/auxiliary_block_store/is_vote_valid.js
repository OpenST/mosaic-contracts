...
contract('AuxiliaryBlockStore.isVoteValid()', async (accounts) => {
  ...
  it('should not accept an unknown source hash', async () => {
    ...
    assert(!isValid, 'Vote expected to be invalid; instead it was valid.');
  });
  ...
  it(
    'should not accept a target block that has a height that is not a multiple of the epoch length',
    async () => {
      const transition = {
        coreIdentifier,
        kernelHash: Utils.ZERO_BYTES32,
  ...
  describe('validate kernel hashes', async () => {
    ...
    it('should return true for valid votes', async () => {
      ...
      await pollingPlace.justify(initialBlockHash, testBlocks[2].hash);
        ...
        [
          {
            ...
            accumulatedTransactionRoot:
              testBlocks[2].accumulatedTransactionRoot,
          },
          {
            dynasty: new BN('1'),
            source: testBlocks[2].hash,
      ...
      await pollingPlace.justify(testBlocks[2].hash, testBlocks[4].hash);
        ...
        [
          {
            ...
            accumulatedTransactionRoot:
              testBlocks[4].accumulatedTransactionRoot,
          },
          {
            dynasty: new BN('2'),
            source: testBlocks[4].hash,
      ...
      await pollingPlace.justify(testBlocks[4].hash, testBlocks[6].hash);
        ...
        [
          {
            ...
            accumulatedTransactionRoot:
              testBlocks[6].accumulatedTransactionRoot,
          },
          {
            dynasty: new BN('3'),
            source: testBlocks[6].hash,
