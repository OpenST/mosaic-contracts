...
//    }
        ...
        public
    {
        ...
        messageBox.inbox[messageHash] = MessageBus.MessageStatus.Declared;
        bytes32 messageHashFromProgressInboxWithProof = MessageBus.progressInboxWithProof(
            messageBox,
            messageTypeHash,
            message,
            rlpEncodedParentNodes,
        ...
        // with outbox state for messageHash is Declared
        messageBox.inbox[messageHash] = MessageBus.MessageStatus.Declared;
        messageHashFromProgressInboxWithProof = MessageBus.progressInboxWithProof(
            messageBox,
            messageTypeHash,
            message,
            rlpEncodedParentNodes,
        ...
        public
    {
        ...
        // with outbox state for messageHash is Declared
        messageBox.outbox[messageHash] = MessageBus.MessageStatus.Declared;
        bytes32 messageHashFromOutboxWithProof = MessageBus.progressOutboxWithProof(
            messageBox,
            messageTypeHash,
            message,
            rlpEncodedParentNodes,
        ...
        messageBox.outbox[messageHash] = MessageBus.MessageStatus.DeclaredRevocation;
        messageHashFromOutboxWithProof = MessageBus.progressOutboxWithProof(
            messageBox,
            messageTypeHash,
            message,
            rlpEncodedParentNodes,
        ...
        public
    {
        ...
        // with outbox state for messageHash is DeclaredRevocation
        messageBox.inbox[messageHash] = MessageBus.MessageStatus.DeclaredRevocation;
        bytes32 messageHashFromProgressInboxRevocation = MessageBus.progressInboxRevocation(
            messageBox,
            message,
            messageTypeHash,
            1,
        ...
        messageBox.inbox[messageHash] = MessageBus.MessageStatus.DeclaredRevocation;
        messageHashFromProgressInboxRevocation = MessageBus.progressInboxRevocation(
            messageBox,
            message,
            messageTypeHash,
            1,
        ...
        public
    {
        ...
        messageBox.outbox[messageHash] = MessageBus.MessageStatus.DeclaredRevocation;
        bytes32 messageHashFromProgressOutboxRevocation = MessageBus.progressOutboxRevocation(
            messageBox,
            message,
            messageTypeHash,
            1,
        ...
        // with outbox state for messageHash is Revoked
        messageBox.outbox[messageHash] = MessageBus.MessageStatus.DeclaredRevocation;
        messageHashFromProgressOutboxRevocation = MessageBus.progressOutboxRevocation(
            messageBox,
            message,
            messageTypeHash,
            1,
