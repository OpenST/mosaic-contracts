...
const ProgressOutboxRevocation = function(){};
...
ProgressOutboxRevocation.prototype = {
	
	progressOutboxRevocation: async function () {
		...
		await messageBusUtils.progressOutboxRevocation(params);
	...
	perform: function (accounts) {
		...
		it('should fail when message status is undeclared ', async () => {
			...
			messageStatus = 0;
			await oThis.progressOutboxRevocation();
...
module.exports = ProgressOutboxRevocation;
