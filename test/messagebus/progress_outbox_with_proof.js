...
let intentHash,
	...
	contract('MessageBus',  async (accounts) => {
		...
		describe('progressOutboxWithProof', async () => {
			...
			it('should fail when message status at target is undeclared and' +
				' message status at source is undeclared', async () => {
			...
			it('should fail when message status at target is undeclared and' +
				' message status at source is declared', async () => {
			...
			it('should fail when message status at target is undeclared and' +
				' message status at source is progressed', async () => {
			...
			it('should fail when message status at target is undeclared and' +
				' message status at source is declared revocation', async () => {
			...
			it('should fail when message status at target is undeclared and' +
				' message status at source is revoked', async () => {
			...
			it('should fail when message status at target is declared revocation' +
				' and message status at source is undeclared', async () => {
			...
			it('should fail when message status at target is declared revocation' +
				' and message status at source is declared', async () => {
			...
			it('should fail when message status at target is declared revocation' +
				' and message status at source is progressed', async () => {
			...
			it('should fail when message status at target is declared revocation' +
				' and message status at source is declared revocation', async () => {
			...
			it('should fail when message status at target is declared revocation' +
				' and message status at source is revoked', async () => {
