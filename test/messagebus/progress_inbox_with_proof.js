	...
	contract('MessageBus',  async (accounts) => {
		...
		describe('progressInboxWithProof', async () => {
			...
			it('should fail when message status at source is undeclared and' +
				' messagehash status in inbox at target is undeclared', async () => {
			...
			it('should fail when message status at source is declared revocation' +
				' and messagehash status in inbox at target is declared', async () => {
			...
			it('should fail when message status at source is declared revocation' +
				' and messagehash status in inbox at target is progressed', async () => {
			...
			it('should fail when message status at source is declared revocation' +
				' and messagehash status in inbox at target is revoked', async () => {
			...
			it('should fail when message status at source is revoked and' +
				' messagehash status in inbox at target is undeclared', async () => {
			...
			it('should fail when message status at source is empty and messagehash' +
				' status in inbox at target is undeclared', async () => {
			...
			it('should fail when message status at source is empty and messagehash' +
				' status in inbox at target is progressed', async () => {
			...
			it('should fail when message status at source is empty and' +
				' messagehash status in inbox at target is revoked', async () => {
