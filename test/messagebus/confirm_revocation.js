...
let intentHash,
	...
	contract('MessageBus',  async (accounts) => {
		...
		describe('confirmRevocation', async () => {
			...
			it('should fail when message status of the message hash is already in declared revocation state ', async () => {
			...
			it('should fail when message status of the message hash in inbox is undeclared state', async () => {
			...
			it('should fail when message status of the message hash in inbox is progressed state', async () => {
