...
const ConfirmRevocation = function(){};
...
ConfirmRevocation.prototype = {
	
	confirmRevocation: async function () {
		...
		await messageBusUtils.confirmRevocation(params);
	...
	perform: function (accounts) {
		...
		it('should fail when message status of the message hash in outbox is declaredrevocation ', async () => {
...
module.exports = ConfirmRevocation;
