...
contract OpenSTValueMock is OpenSTValue {
	...
	bytes32 public intentsMappingKey = keccak256(abi.encodePacked(uint256(0))); 
	bytes32 public intentsMappingValue = keccak256(abi.encodePacked(uint256(1)));
	...
	function testIntentsMapping() public {
